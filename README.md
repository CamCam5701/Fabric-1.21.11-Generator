...
## This plugin is a fork from [Goldorions Fabric 26.1.2 generator](https://mcreator.net/plugin/64512/mcreator-fabric-generator).

A plugin for MCreator, a code generator to create Minecraft mods. Which adds support for Minecraft Fabric 1.21.11

This project is not official. It is not affiliated with the respective owners and maintainers of Fabric, Minecraft, or MCreator. Do not expect any official support from their communities.

**The current targeted Minecraft version is 1.21.11.**

This 1.21.11 port uses Fabric Loader 0.19.3, Loom 1.17-SNAPSHOT (remap), Gradle 9.5.1, Java 21 target, and Fabric API 0.141.6+1.21.11.19.3, Loom 1.17-SNAPSHOT, Gradle 9.5.1, Java 25, and Fabric API 0.155.2+26.2.
